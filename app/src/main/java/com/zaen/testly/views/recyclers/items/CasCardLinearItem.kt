...
class CasCardLinearItem(val card: CardData) : AbstractFlexibleItem<CasCardLinearItem.ViewHolder>() {
    ...
    override fun getLayoutRes(): Int{
        return R.layout.item_recycler_linear_create_card
    }
    ...
    class ViewHolder(val view: View?, val adapter: FlexibleAdapter<IFlexible<RecyclerView.ViewHolder>>?) : FlexibleViewHolder(view,adapter) {
        val titleText: TextView? = view?.findViewById(R.id.title_item_linear_create_card)
        val dateText: TextView? = view?.findViewById(R.id.text_date_linear_create_card)
        init{
